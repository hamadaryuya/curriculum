...
FROM stock_table
INNER JOIN store_table ON stock_table.quantity = store_table.store_name
INNER JOIN goods_table ON store_table.store_name = goods_table.goods_name
